...
;*****************************************************************
;* battery voltage and bumper state Display
;*****************************************************************
...
TENS        RMB 1    ;10 digit
UNITS       RMB 1    ;1 digit
BCD_SPARE   RMB 10   ; Extra space for decimal point and string terminator ADDED
...
; Subroutine section
;*******************************************************************
;* Initialization  LCD: 4-bit data width, 2-line display, * 
