;*****************************************************************
;* Sarim Shahwar & Hamza Makrod- COE538 EEBOT GUIDANCE CHALLENGE *
;*****************************************************************
              XDEF Entry, _Startup ;
              ABSENTRY Entry 
...
;***********************
START         EQU   0
FWD           EQU   1                     ;Setting States equavalent to a certain value
ALL_STOP      EQU   2                     ;Which will be called throughout the code
LEFT_TRN      EQU   3
RIGHT_TRN     EQU   4
REV_TRN       EQU   5                     
LEFT_ALIGN    EQU   6                     
RIGHT_ALIGN   EQU   7 
;***************************************************
;Turning timer for eebot (for full left/rigt turn).*
T_LEFT        EQU   8                             ;*
T_RIGHT       EQU   8                             ;*
;***************************************************
...
BASE_STBD     FCB   $CC
;*****************************************************************************
LINE_VARIANCE           FCB   $20           ; Adding variance based on testing to 
BOW_VARIANCE            FCB   $30           ; Sensor readings are compared to the baseline values:
PORT_VARIANCE           FCB   $20           ; with the added or subtracted variances.           
MID_VARIANCE            FCB   $20
STARBOARD_VARIANCE      FCB   $18
;*****************************************************************************
...
;*******************************************************
;Initializing photoresistors sensor (Storage Registrar)*
;*******************************************************
SENSOR_LINE   FCB   $01                      
SENSOR_BOW    FCB   $23                     ;These storage locations are  used to hold initial sensor readings 
SENSOR_PORT   FCB   $45                     ;or reference values for comparison in the subsequent sections of the code. 
SENSOR_STBD   FCB   $89                     ;The actual use of these values would depend on the context of the program,
SENSOR_MID    FCB   $67                     ;and how these values are updated during the execution of the code.
SENSOR_NUM    RMB   1 
